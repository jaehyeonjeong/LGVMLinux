...
void acc_mask(Mat acc_mat, Mat& acc_dst, Size size, int theta)
{
...
void houghLines(Mat src, vector<Vec2f>& s_lines, double rho, double theta, int thres)
{
	Mat acc_mat, acc_dst;
...
int main()
{
	Mat image = imread("../Images/line1.bmp", 0);
